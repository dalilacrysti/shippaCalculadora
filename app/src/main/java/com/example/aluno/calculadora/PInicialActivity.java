...
public class PInicialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinicial);
        ...
        salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(PInicialActivity.this, p.getNome() + " cadastrado!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PInicialActivity.this, "Preencha todos os campos", Toast.LENGTH_SHORT).show();
        ...
        listarProdutos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Chama a outra tela
                startActivity( new Intent(PInicialActivity.this, ProdutosActivity.class) );
